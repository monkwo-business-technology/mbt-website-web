            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-card rounded-2xl p-8 border border-border/50">
                ...
                <p className="text-muted-foreground mb-6">
                  Let's discuss how {solution.shortTitle.toLowerCase()} can transform your business.
                </p>
                <a
                  href="#contact"
              ...
              {prevSolution ? (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="font-medium text-foreground">{prevSolution.shortTitle}</p>
                  </div>
                </Link>
              ) : (
                <div />
              ...
              {nextSolution && (
                ...
                >
                  <div>
                    ...
                    <p className="font-medium text-foreground">{nextSolution.shortTitle}</p>
                  </div>
        ...
        <section id="contact" className="py-20 md:py-24 bg-foreground text-background">
          <div className="max-w-4xl mx-auto px-4 lg:px-6 text-center">
            ...
            <p className="text-background/70 mb-8 max-w-2xl mx-auto">
              Ready to transform your business with {solution.shortTitle.toLowerCase()}?
